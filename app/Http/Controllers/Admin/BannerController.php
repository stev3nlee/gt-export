...
use App\Models\Banner_language;
...
class BannerController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $path = base_path() . '/public/upload/banner';
    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            if ($request->input('old_image') != null) {
                $oldimage = base_path() . '/public/upload/banner/' . $request->input('old_image');
    ...
    {
        $banner_language = Banner_language::where('language_id', $request->input('language_id'))->where('banner_id', $request->input('banner_id'))->first();
        if (empty($banner_language)) {
            $banner_language = new Banner_language;
            $banner_language->banner_id = $request->input('banner_id');
