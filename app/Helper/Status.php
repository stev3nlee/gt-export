...
class Status
{
    public $error = [
        ...
        'EXCEED_PLAN' => [
            'errorCode' => 20612,
            'message' => 'This week meal already full.',
        ],
        'DIET_PREFERENCE_EMPTY' => [
            'errorCode' => 20512,
            'message' => 'Please chose diet preference.',
        ],
        'DIET_PREFERENCE_NOT_SAME' => [
            'errorCode' => 20513,
            'message' => 'Diet preference must be same per week.',
        ],
        'GUEST_ONLY_TRIAL' => [
            'errorCode' => 20514,
            'message' => 'Guest only can add meal for 1 week.',
        ],
        'SUBSCRIPTION_EMPTY' => [
            'errorCode' => 20520,
        ...
        'ORDER_FIRST_WEEK' => [
            'errorCode' => 20615,
            'message' => 'Please choose meal for first week.',
        ],
        'ORDER_NOT_FOUND' => [
            'errorCode' => 20501,
