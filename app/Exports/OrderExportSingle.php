		...
		for ($i = 0; $i < $order_length; $i++) {
            ...
            // dd((float) number_format($current_order_detail->product_variant_price * $current_order_detail->product_quantity, 2, '.', ''));
                array_push($data, [
                    ...
                    'Shipping: Full Name' => $current_order->order_shipping_address->first_name . $current_order->order_shipping_address->last_name,
                    'Shipping: Phone Number' => $current_order->order_shipping_address->phone_number,
                    'Shipping: E-mail Address' => $current_order->order_shipping_address->email,
                    'Shipping: Address' => $current_order->order_shipping_address->address.', '.$current_order->order_shipping_address->district.', '.$current_order->order_shipping_address->city.', '.$current_order->order_shipping_address->province.', '.$current_order->order_shipping_address->country.', '.$current_order->order_shipping_address->zip_code,
                    ...
                    'Payment Method' => $current_order->payment_method,
                ]);
