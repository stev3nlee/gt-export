                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="number" min=0 step=".01" name="price" class="form-control" id="price">
                          </div>
                        </div>
                ...
                <div class="box-body">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea name="economy_performance" class="form-control my-editor"></textarea>
                        </div>

                        <div class="form-group">
                          <label for="exampleInputEmail1">Exterior Features</label>
                          <textarea name="exterior_features" class="form-control my-editor"></textarea>
                        </div>

                        <div class="form-group">
                          <label for="exampleInputEmail1">Technical</label>
                          <textarea name="technical" class="form-control my-editor"></textarea>
                        </div>
