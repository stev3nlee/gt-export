    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <nav class="navbar navbar-static-top css-header" role="navigation" style="background-color: #003F5A">
          ...
          @include('vendor.backpack.base.inc.menu')
        </nav>
      </header>
      ...
      <footer class="main-footer">
        <!-- @if (config('backpack.base.show_powered_by'))
            <div class="pull-right hidden-xs">
              {{ trans('vendor.backpack.base.base.powered_by') }} <a target="_blank" href="http://backpackforlaravel.com?ref=panel_footer_link">Backpack for Laravel</a>
            </div>
        @endif
        {{ trans('vendor.backpack.base.base.handcrafted_by') }} <a target="_blank" href="{{ config('backpack.base.developer_link') }}">{{ config('backpack.base.developer_name') }}</a>. -->
      </footer>
    </div>
    <!-- ./wrapper -->
   <!--  <style type="text/css">
