        ...
        <div class="col-md-12">
            <div class="box box-default">
                ...
                <div class="box-body">
                          ...
                          <form role="form" method="POST" action="{{ url(config('backpack.base.route_prefix').'/regulation/update') }}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group @if($errors->has('image')) has-error @endif">
                              ...
                              <img src="{{ asset('/upload/regulation/'.$data->image) }}" width="40%" />
