        ...
        <div class="col-md-12">
            <div class="box box-default">
                ...
                <div class="box-header with-border">
                    ...
                    <!-- <div class="box-title"><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/about/create') }}" class="btn btn-success">Create about</a></div> -->
                </div>
                                ...
                                <tr data-element-id='{{ $content->id }}' data-sort='{{ $content->sort }}'>
                                    <td>
                                       <div class="table-actions-hover">
                                            <a href="{{ url(config('backpack.base.route_prefix', 'admin').'/about/edit/'.$content->id) }}"><i class="fa fa-pencil fa-fw"></i></a>
                                            <!-- <a onclick="return confirm('Are you sure ?');" href="{{ url(config('backpack.base.route_prefix', 'admin').'/about/delete/'.$content->id) }}"><i class="fa fa-trash fa-fw"></i></a> -->
                                        </div>
                                    </td>
                                    <td>{{ $content->title }}</td>
    ...
    $('.sortable-treatment').sortable({
        ...
        stop: function( event, ui ) {
            ...
            $('#element-order > tr').each(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ url(config('backpack.base.route_prefix').'/about/update_sort') }}",
